...
abstract class VoidActionCubit<Response, Failure> extends Cubit<VoidActionCubitState<Failure>>
    implements StateStreamableSource<VoidActionCubitState<Failure>> {
  VoidActionCubit({
